...
import Experience from './AboutsComponents/Experience';
import Education from './AboutsComponents/Education';
...
const About = () => {
  ...
  return (
    <div style={{ backgroundColor: getBackgroundColor() }} className="transition-colors duration-500">
